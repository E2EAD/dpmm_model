...
class Configuration:
    ...
    traj_time_near = None
    traj_time_far = None
    traj_interval_near = None
    traj_interval_far = None
    token_nums = None
    image_crop = None
    image_scale = None
...
def get_cfg(cfg_yaml: dict):
    ...
    cfg.ability_list = config['ability_list']

    # cfg.train_dataset = config['training_folder']
    # cfg.val_dataset = config['validation_folder']
    cfg.future_frame_nums = config['future_frame_nums']
    cfg.hist_frame_nums = config['hist_frame_nums']
    cfg.traj_time_near = config['traj_time_near']
    cfg.traj_time_far = config['traj_time_far']
    cfg.traj_interval_near = config['traj_interval_near']
    cfg.traj_interval_far = config['traj_interval_far']
    cfg.token_nums = config['token_nums']
    cfg.image_crop = config['image_crop']
    cfg.image_scale = config['image_scale']
    ...
    cfg.use_detection_conv_layers = config['use_detection_conv_layers'] 
    cfg.detection_threshold = config['detection_threshold']
    cfg.bev_encoder_output_H = config['bev_encoder_output_H']
    cfg.bev_encoder_output_W = config['bev_encoder_output_W']
